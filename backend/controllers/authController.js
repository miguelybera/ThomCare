...
exports.registerAdmin = catchAsyncErrors(async (req, res, next) => {
    ...
    if ((req.body.email.substr(-10) !== "ust.edu.ph")||(req.body.email.substr(-19) !== "ust-ics.mygbiz.com")) { return next(new ErrorHandler('UST GSuite accounts are only allowed')) } // will change to ust.edu.ph only after development
